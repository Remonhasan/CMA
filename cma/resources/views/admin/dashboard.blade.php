            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <h3 class="card-title">{{ $courseCount }}
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <a href="#pablo">Total Courses and Students</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <h3 class="card-title">{{ $registrations->count() }}</h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">local_offer</i>Not Confirmed Registration
                  </div>
                </div>
              </div>
            </div>
